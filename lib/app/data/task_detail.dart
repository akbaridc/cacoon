...
List<TaskDetail> taskDetailFromJson(String str) => List<TaskDetail>.from(json.decode(str).map((x) => TaskDetail.fromJson(x)));

String taskDetailToJson(List<TaskDetail> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class TaskDetail {
    ...
    factory TaskDetail.fromJson(Map<String, dynamic> json) => TaskDetail(
        ...
        vpPhotoVessel: json["vp_photo_vessel"],
        vpPhotoSelfie: json["vp_photo_selfie"],
