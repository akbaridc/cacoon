              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(boat.vslName, style: const TextStyle(fontWeight: FontWeight.bold)),
                      const SizedBox(height: 4),
                      Text('${boat.vslArrivalType} | ${boat.vslContractTonnage} Ton ${boat.vslCargoName}',
                          style: const TextStyle(fontSize: 12)),
                      const SizedBox(height: 2),
                      Text('Tujuan : ${boat.vslDestination}', style: const TextStyle(fontSize: 12)),
                    ],
                  ),
                ),
                const Positioned(
